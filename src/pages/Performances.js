        ...
        <div className="flex items-center justify-between py-4">
          <div className="flex items-center gap-2 overflow-x-auto">
            {categories.map((category) => (
              <motion.button
                ...
                className={`px-4 py-2 rounded-full text-sm font-semibold tracking-[0.08em] uppercase font-body whitespace-nowrap transition-all ${
          ...
          <div className={`inline-flex rounded-lg border ${borderColor} p-1`}>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-semibold tracking-[0.08em] uppercase font-body transition-colors ${
                viewMode === 'grid'
