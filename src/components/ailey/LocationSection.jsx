    ...
    <section id="our-location" className="relative min-h-[600px] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <motion.div 
          ...
          className="max-w-3xl"
        >
          <h2 className="text-orange-500 text-sm font-bold tracking-[0.3em] uppercase mb-6">Our Location</h2>
          <h3 className={`${isDarkMode ? 'text-white' : 'text-white'} text-3xl md:text-5xl font-bold leading-tight mb-8`}>
            Our dance center is the premier dedicated dance facility in Kingston, the cultural capital of the Caribbean.
          </h3>
          <div className="flex flex-wrap gap-4">
            <button className="bg-orange-500 hover:bg-orange-600 text-black px-8 py-6 text-sm tracking-wider font-medium flex items-center">
              <MapPin className="mr-2 h-4 w-4" /> Plan Your Visit
            </button>
