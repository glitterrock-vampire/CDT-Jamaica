...
const melaninMigrationUpdate = {
  ...
  year: 2023,
  // Note: dancers field might need to be handled differently depending on schema
  // This assumes there's a 'dancers' field or similar
  // If dancers should be in a different field, adjust accordingly
}
...
async function createMelaninMigration() {
  try {
    ...
    const newEntry = {
      ...
      year: 2023,
      status: 'active',
      category: 'contemporary', // or 'jamaican' depending on your schema
      isFeatured: false,
...
export { updateMelaninMigration, createMelaninMigration, main }
